---
name: map-backend-module
description: 为了保持项目文档更新保障项目基础文档结构不过期，你将维护项目地图等相关依赖文档，对于本次更新的模块总结模块内容、模块依赖关系、接口调整结果更新项目说明结构，当用户提到“项目地图”、“更新模块说明”、“更新模块文档”、“更新项目地图”、“创建项目地图”、“更新map”、“创建map”时触发本技能。
references:
